...
function zendesk_request_form_shortcode($atts, $content = null) {
	...
	extract(shortcode_atts(array(
		...
		'email_placeholder' => '', // show a placeholder in the email field
	...
	if ($ticket_num != 0) {
		...
		if (strlen($requester_email) > 3) { // taken from user account
			...
			$output .= '  <input type="email" name="zen_email" id="zen_email" value="" placeholder="'.esc_attr($email_placeholder).'" required>';
		}
		$output .= '</p>';
